...
static struct acpu_level acpu_freq_tbl_2p3g_pvs0[] __initdata = {
	...
	{ 0, { 2188800, HFPLL, 1, 114 }, L2(20), 1085000, 659 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(20), 1100000, 691 },
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, { 2304000, HFPLL, 1, 120 }, L2(20), 1115000, 1   },
	{ 1, { 2419200, HFPLL, 1, 126 }, L2(20), 1135000, 1   },
	{ 1, { 2534400, HFPLL, 1, 132 }, L2(20), 1155000, 1   },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs1[] __initdata = {
	...
	{ 0, { 2188800, HFPLL, 1, 114 }, L2(20), 1060000, 659 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(20), 1075000, 691 },
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, { 2304000, HFPLL, 1, 120 }, L2(20), 1090000, 1   },
	{ 1, { 2419200, HFPLL, 1, 126 }, L2(20), 1110000, 1   },
	{ 1, { 2534400, HFPLL, 1, 132 }, L2(20), 1130000, 1   },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs2[] __initdata = {
	...
	{ 0, { 2188800, HFPLL, 1, 114 }, L2(20), 1035000, 659 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(20), 1050000, 691 },
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, { 2304000, HFPLL, 1, 120 }, L2(20), 1065000, 1   },
	{ 1, { 2419200, HFPLL, 1, 126 }, L2(20), 1085000, 1   },
	{ 1, { 2534400, HFPLL, 1, 132 }, L2(20), 1105000, 1   },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs3[] __initdata = {
	...
	{ 0, { 2188800, HFPLL, 1, 114 }, L2(20), 1010000, 659 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(20), 1025000, 691 },
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, { 2304000, HFPLL, 1, 120 }, L2(20), 1040000, 1   },
	{ 1, { 2419200, HFPLL, 1, 126 }, L2(20), 1060000, 1   },
	{ 1, { 2534400, HFPLL, 1, 132 }, L2(20), 1080000, 1   },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs4[] __initdata = {
	...
	{ 0, { 2188800, HFPLL, 1, 114 }, L2(20),  985000, 659 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(20), 1000000, 691 },
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, { 2304000, HFPLL, 1, 120 }, L2(20), 1015000, 1   },
	{ 1, { 2419200, HFPLL, 1, 126 }, L2(20), 1035000, 1   },
	{ 1, { 2534400, HFPLL, 1, 132 }, L2(20), 1055000, 1   },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs5[] __initdata = {
	...
	{ 0, { 2188800, HFPLL, 1, 114 }, L2(20),  965000, 659 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(20),  975000, 691 },
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, { 2304000, HFPLL, 1, 120 }, L2(20),  990000, 1   },
	{ 1, { 2419200, HFPLL, 1, 126 }, L2(20), 1010000, 1   },
	{ 1, { 2534400, HFPLL, 1, 132 }, L2(20), 1030000, 1   },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs6[] __initdata = {
	...
	{ 0, { 2188800, HFPLL, 1, 114 }, L2(20),  940000, 659 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(20),  950000, 691 },
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, { 2304000, HFPLL, 1, 120 }, L2(20),  965000, 1   },
	{ 1, { 2419200, HFPLL, 1, 126 }, L2(20),  985000, 1   },
	{ 1, { 2534400, HFPLL, 1, 132 }, L2(20), 1005000, 1   },
#endif
	{ 0, { 0 } }
};
